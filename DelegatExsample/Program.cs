using DelegatExsample.Exstansion;

var usersA = new List<User>
{
    new(Guid.Parse("99E3BA84-B062-4132-A691-6EA6C720E3FB"), "Mavlonbek", "Isroilov"),
    new(Guid.Parse("A2DAD52F-639D-4EDC-AD5A-530C280A1017"), "Mirsaid", "Ikromov")
};
